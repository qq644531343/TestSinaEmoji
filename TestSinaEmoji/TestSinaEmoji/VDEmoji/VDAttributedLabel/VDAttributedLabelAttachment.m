...
{
    VDAttributedLabelAttachment *image = (__bridge VDAttributedLabelAttachment *)ref;
    CGFloat ascent = 0;
...
#pragma mark - VDAttributedLabelImage
@interface VDAttributedLabelAttachment ()
...
{
    VDAttributedLabelAttachment *attachment    = [[VDAttributedLabelAttachment alloc]init];
