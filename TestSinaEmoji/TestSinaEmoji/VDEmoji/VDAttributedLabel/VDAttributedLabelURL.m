...
static VDCustomDetectLinkBlock customDetectBlock = nil;

@implementation VDAttributedLabelURL

+ (VDAttributedLabelURL *)urlWithLinkData: (id)linkData
                                     range: (NSRange)range
                                     color: (UIColor *)color
{
    VDAttributedLabelURL *url  = [[VDAttributedLabelURL alloc]init];
        ...
        if ([plainText length])
        {
            ...
            [urlRegex enumerateMatchesInString:plainText
                                    ...
                                    usingBlock:^(NSTextCheckingResult *result, NSMatchingFlags flags, BOOL *stop) {
                                        ...
                                        VDAttributedLabelURL *link = [VDAttributedLabelURL urlWithLinkData:text
                                                                                                       range:range
                                                                                                       color:nil];
